# -*- coding: utf-8 -*-
"""
ComfyUI-DirectorMaster V16.8.0-MERGED — 18 注册节点 (17 超级节点 + Final 别名) + 600 导演库
====================================================================
...
# 标记 V16.8.0-MERGED 版本 (V16.8.0 批次6: 一致性资产化; V16.7.0 批次3: 质量闭环+管线韧性; 批次2: 知识资产工程+分镜契约基座; 批次1: LLM 链路加固+加载隔离)
__version__ = "16.8.0"
